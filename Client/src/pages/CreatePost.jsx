...
const CreatePost = () => {
  ...
  const handleSubmit= async (e)=>{
      ...
      if(form.prompt && form.photo){
        ...
        alert('Please enter the prompt or image')
      }
  }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
       <div>
          ...
          >Create</h1>
          <p className='mt-2 text-[#666e75] text-[16px] max-w-[520px] '>
        ...
        <form  className='mt-8 max-w-3xl' onSubmit={handleSubmit}>
             ...
             <div className='mt-3'>
                <p className='mt-2 text-[#666375] text-[14px]'>Once you have created the image you want, you can share it with other in the community </p>
                <button
                type='submit'
